...
func sortImports(sections, localPrefix string, fset *token.FileSet, f *ast.File) {
	for i, d := range f.Decls {
		...
		//	}
		//}
		specs = append(specs, sortSpecs(sections, localPrefix, fset, f, d.Specs[i:])...)
		d.Specs = specs
...
func sortSpecs(sections, localPrefix string, fset *token.FileSet, f *ast.File, specs []ast.Spec) []ast.Spec {
	...
	sort.Sort(byImportSpec{sections: sections, localPrefix: localPrefix, specs: specs})
...
func (x byImportSpec) Less(i, j int) bool {
	...
	igroup := importGroup(x.sections, x.localPrefix, ipath)
	jgroup := importGroup(x.sections, x.localPrefix, jpath)
	if igroup != jgroup {
